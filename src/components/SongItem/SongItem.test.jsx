...
describe('SongItem', () => {
    ...
    describe('Visual states', () => {
        test('applies "filtered" class when isFiltered is true', () => {
            render(<SongItem song={mockSong} isFiltered={true} />);
            expect(screen.getByRole('listitem')).toHaveClass('filtered');
        });

        test('applies "toggling-favorite" class when isTogglingFavorite is true', () => {
            render(<SongItem song={mockSong} isTogglingFavorite={true} />);
            expect(screen.getByRole('listitem')).toHaveClass('toggling-favorite');
        });
    });
});